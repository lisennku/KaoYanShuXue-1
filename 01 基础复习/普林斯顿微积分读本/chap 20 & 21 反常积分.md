...
- >  <font size=5 color=blue>$p(x)$是一个多项式函数，若$p(x)$的最高次项是$ax^n$，则当$x \to \infty$或$x \to -\infty$时，有$p(x)～ax^n$</font>
...
- 例：
    ...
    - $\displaystyle \int_0^{\infty}\frac 1 {x^5 + 4x^4 +1}dx$
        ...
        - $$
            ...
            \begin{aligned}
            & \infty是唯一瑕点，所以无需拆分积分 \\
            & 当x \to \infty时，x^5 + 4x^4 +1 ～ x^4 ，则有\frac 1 {x^5 + 4x^4 +1} ～ \frac 1 {x^5} \\
            ...
            & 第一个函数没有瑕点 直接收敛 \\
            & 第二个积分，因为\frac 1 {x^5 + 4x^4 +1} ～ \frac 1 {x^5}，且 \int_1^{\infty}\frac 1 {x^5}dx收敛，所以第二个积分收敛 \\
            & 所以原积分收敛
            \end{aligned}
            $$
    ...
    - $\displaystyle \int_2^{\infty}\frac {3x^5 + 2x^2 +9} {x^6 + 22x^4 + \sqrt{4x^{13}+18x}}dx$
        ...
        - $$
            ...
            & 当 x \to \infty时，\\
            & 分子3x^5 + 2x^2 +9 ～ 3x^5 \\
            & 分母x^6 + 22x^4 + \sqrt{4x^{13}+18x} ～ 2x^{13/2} \\
            & 所以当 x \to \infty时，\frac {3x^5 + 2x^2 +9} {x^6 + 22x^4 + \sqrt{4x^{13}+18x}} ～ \frac {3x^5} {2x^{13/2}} = \frac 3 2 \frac 1 {x^{3/2}} \\
    ...
    - $\displaystyle \int_9^{\infty}\frac 1 {\sqrt{x^4+8x^3-9}-x^2}dx$
        ...
        - $$
          ...
          & 当x \to \infty时，\frac {\sqrt{x^4+8x^3-9}+x^2}{x^4+8x^3-9 - x^4} ～ \frac {2x^2} {8x^3} = \frac 1 {4x} \\
...
- > <font size =5 color=blue>$p(x)$是一个多项式函数，若$p(x)$的最低次项是$bx^m$，则当$x \to 0$时，$p(x)～bx^m$</font>
...
& 　　　当x \to 0时，有 \frac 1 {x^2 + \sqrt{x}}～\frac 1 {\sqrt{x}} \\
& 　　　而\int_0^5\frac 1 {\sqrt{x}}dx，根据p判断法是收敛的，所以第一个积分收敛\\
& \int_5^{\infty}\frac 1 {x^2 + \sqrt{x}}dx\\
& 　　　当x \to \infty时，有\frac 1 {x^2 + \sqrt{x}}～\frac 1 {x^2}\\
...
- 例
    ...
    - $\displaystyle \int_5^{\infty}\frac {|sin(x^4)|} {\sqrt{x}+x^2}dx$
        ...
        - $$
            ...
            & 当x \to \infty时，\frac 1 {\sqrt{x}+x^2}～\frac 1 {x^2}\\
    ...
    - $\displaystyle \int_8^{\infty} \frac 1 {2x^3-3x^{0.1}+sin(100x^{200})}dx$
        ...
        - $$
            \begin{align*}
            & 当x \to \infty时，2x^3-3x^{0.1}+sin(100x^{200})～2x^3，则有\frac 1 {2x^3-3x^{0.1}+sin(100x^{200})} ～ \frac 1 {2x^3}\\
...
> <font size=5 color=blue>当$x \to 0$时，有$sin(x)～x$, $tan(x)～x$,  $cos(x)～1$</font>
...
& 　　　当x \to 0时，有sin(x) ～ x，则有\frac {sin(x)} {x^{3/2}}～\frac {x} {x^{3/2}}=\frac 1 {x^{1/2}}\\
...
- 例：
    ...
    - $\displaystyle\int_{10}^{\infty}(x^{1000}+x^2+sin(x))e^{-x^2+6}dx$
        ...
        - $$
            \begin{align*}
            & 当x \to \infty，x^{1000}+x^2+sin(x)～x^{1000}，则有(x^{1000}+x^2+sin(x))e^{-x^2+6}～x^{1000}e^{-x^2+6}\\
    ...
    - $\displaystyle\int_9^{\infty}\frac {x^{10}} {e^x - 5x^{20}}dx$
        ...
        - $$
            ...
            & \therefore 当x \to \infty 时，e^x - 5x^{20} ～ e^x，进而有 \frac {x^{10}} {e^x - 5x^{20}}～\frac {x^{10}} {e^x} \\
    ...
    - $\displaystyle\int_{18}^{\infty}\frac {x^2} {7^x-4^x}dx$
        ...
        - $$
            ...
            & \therefore 当x\to\infty时，有7^x - 4^x～7^x，故而有\frac {x^2} {7^x-4^x}～\frac {x^2} {7^x}\\
...
> <font color=blue size=5>指数函数对0没有作用，准确的说，是当$x \to 0$时，有$e^x ～1$和$e^{-x}～1$ </font>

> 特别的，当$x \to 0$时，有$e^x-1～x$
